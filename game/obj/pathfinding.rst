   ...
   3F0C 3A 45 64      [13]   62 	ld	a,(#_sol_tam + 0)
   3F0F D6 C8         [ 7]   63 	sub	a, #0xC8
   3F11 30 2D         [12]   64 	jr	NC,00102$
                             65 ;src/pathfinding.c:14: camino[sol_tam] = x;
   3F13 01 46 64      [10]   66 	ld	bc,#_camino+0
   3F16 2A 45 64      [16]   67 	ld	hl,(_sol_tam)
   ...
   3F26 21 45 64      [10]   75 	ld	hl, #_sol_tam+0
   3F29 34            [11]   76 	inc	(hl)
                             77 ;src/pathfinding.c:16: camino[sol_tam] = y;
   3F2A 2A 45 64      [16]   78 	ld	hl,(_sol_tam)
   ...
   3F3A 21 45 64      [10]   86 	ld	hl, #_sol_tam+0
   ...
   4053 CD 61 4B      [17]  252 	call	_getTilePtr
   ...
   40AF CD 61 4B      [17]  290 	call	_getTilePtr
   ...
   40C1 CD A5 4B      [17]  301 	call	_abs
   ...
   40F4 CD A5 4B      [17]  320 	call	_abs
   ...
   4145 CD 61 4B      [17]  355 	call	_getTilePtr
   ...
   4165 CD 61 4B      [17]  374 	call	_getTilePtr
   ...
   4186 CD A5 4B      [17]  389 	call	_abs
   ...
   41B9 CD A5 4B      [17]  408 	call	_abs
   ...
   422B CD 61 4B      [17]  461 	call	_getTilePtr
   ...
   426A CD 61 4B      [17]  496 	call	_getTilePtr
   ...
   4286 CD 61 4B      [17]  514 	call	_getTilePtr
   ...
   44A7 DD 96 F0      [19]  797 	sub	a, -16 (ix)
   44AA 20 08         [12]  798 	jr	NZ,00113$
   44AC DD 7E 07      [19]  799 	ld	a,7 (ix)
   44AF DD 96 F2      [19]  800 	sub	a, -14 (ix)
   44B2 28 06         [12]  801 	jr	Z,00109$
   44B4                     802 00113$:
   44B4 DD 7E F1      [19]  803 	ld	a,-15 (ix)
   ...
   44C0 3A 45 64      [13]  811 	ld	a,(#_sol_tam + 0)
   ...
   44CA DD 36 EF 00   [19]  819 	ld	-17 (ix),#0x00
   ...
   44DE DD 66 F2      [19]  829 	ld	h,-14 (ix)
   44E1 DD 6E F0      [19]  830 	ld	l,-16 (ix)
   ...
   4510 DD 7E F2      [19]  860 	ld	a,-14 (ix)
   4513 C6 FE         [ 7]  861 	add	a,#0xFE
   4515 DD 77 FA      [19]  862 	ld	-6 (ix), a
   4518 F5            [11]  863 	push	af
   4519 33            [ 6]  864 	inc	sp
   451A DD 7E F0      [19]  865 	ld	a,-16 (ix)
   451D F5            [11]  866 	push	af
   451E 33            [ 6]  867 	inc	sp
   451F CD 0A 3F      [17]  868 	call	_anyadirALista
   4522 F1            [10]  869 	pop	af
   4523 DD 75 F7      [19]  870 	ld	-9 (ix), l
   4526 DD 75 F1      [19]  871 	ld	-15 (ix), l
                            872 ;src/pathfinding.c:171: y = y-2;
   4529 DD 4E FA      [19]  873 	ld	c,-6 (ix)
   452C DD 71 F2      [19]  874 	ld	-14 (ix),c
                            875 ;src/pathfinding.c:172: k = k+2;
   452F DD 7E FD      [19]  876 	ld	a,-3 (ix)
   4532 DD 77 EE      [19]  877 	ld	-18 (ix),a
   ...
   4538 DD 7E F2      [19]  883 	ld	a,-14 (ix)
   453B C6 02         [ 7]  884 	add	a, #0x02
   453D DD 77 F7      [19]  885 	ld	-9 (ix), a
   4540 F5            [11]  886 	push	af
   4541 33            [ 6]  887 	inc	sp
   4542 DD 7E F0      [19]  888 	ld	a,-16 (ix)
   4545 F5            [11]  889 	push	af
   4546 33            [ 6]  890 	inc	sp
   4547 CD 0A 3F      [17]  891 	call	_anyadirALista
   454A F1            [10]  892 	pop	af
   454B DD 75 FA      [19]  893 	ld	-6 (ix), l
   454E DD 75 F1      [19]  894 	ld	-15 (ix), l
                            895 ;src/pathfinding.c:178: y = y+2;
   4551 DD 4E F7      [19]  896 	ld	c,-9 (ix)
   4554 DD 71 F2      [19]  897 	ld	-14 (ix),c
                            898 ;src/pathfinding.c:179: k = k+2;
   4557 DD 7E FD      [19]  899 	ld	a,-3 (ix)
   455A DD 77 EE      [19]  900 	ld	-18 (ix),a
   ...
   4560 DD 46 F0      [19]  906 	ld	b,-16 (ix)
   4563 05            [ 4]  907 	dec	b
   4564 C5            [11]  908 	push	bc
   4565 DD 7E F2      [19]  909 	ld	a,-14 (ix)
   ...
   4571 DD 75 F1      [19]  917 	ld	-15 (ix),l
                            918 ;src/pathfinding.c:185: x = x-1;
   4574 DD 70 F0      [19]  919 	ld	-16 (ix),b
                            920 ;src/pathfinding.c:186: k = k+2;
   4577 DD 7E FD      [19]  921 	ld	a,-3 (ix)
   457A DD 77 EE      [19]  922 	ld	-18 (ix),a
   ...
   4580 DD 7E F0      [19]  928 	ld	a,-16 (ix)
   4583 3C            [ 4]  929 	inc	a
   4584 DD 77 F7      [19]  930 	ld	-9 (ix),a
   4587 DD 66 F2      [19]  931 	ld	h,-14 (ix)
   458A DD 6E F7      [19]  932 	ld	l,-9 (ix)
   458D E5            [11]  933 	push	hl
   458E CD 0A 3F      [17]  934 	call	_anyadirALista
   4591 F1            [10]  935 	pop	af
   4592 DD 75 F1      [19]  936 	ld	-15 (ix),l
                            937 ;src/pathfinding.c:190: x = x+1;
   4595 DD 7E F7      [19]  938 	ld	a,-9 (ix)
   4598 DD 77 F0      [19]  939 	ld	-16 (ix),a
                            940 ;src/pathfinding.c:191: k = k+2;
   459B DD 7E FD      [19]  941 	ld	a,-3 (ix)
   459E DD 77 EE      [19]  942 	ld	-18 (ix),a
   ...
   45AE 3A 45 64      [13]  954 	ld	a,(#_sol_tam + 0)
   ...
   45BB 3A 45 64      [13]  960 	ld	a,(#_sol_tam + 0)
   45BE 77            [ 7]  961 	ld	(hl),a
   45BF 18 08         [12]  962 	jr	00142$
   45C1                     963 00122$:
                            964 ;src/pathfinding.c:205: actual->longitud_camino = CAMINO_TAM;
   45C1 DD 6E FE      [19]  965 	ld	l,-2 (ix)
   45C4 DD 66 FF      [19]  966 	ld	h,-1 (ix)
   45C7 36 C8         [10]  967 	ld	(hl),#0xC8
                            968 ;src/pathfinding.c:207: for (i; i<actual->longitud_camino; i++){
   45C9                     969 00142$:
   45C9 DD 7E FB      [19]  970 	ld	a,-5 (ix)
   45CC C6 19         [ 7]  971 	add	a, #0x19
   45CE DD 77 FB      [19]  972 	ld	-5 (ix),a
   45D1 DD 7E FC      [19]  973 	ld	a,-4 (ix)
   45D4 CE 00         [ 7]  974 	adc	a, #0x00
   45D6 DD 77 FC      [19]  975 	ld	-4 (ix),a
   45D9 DD 36 F3 00   [19]  976 	ld	-13 (ix),#0x00
   45DD                     977 00129$:
   45DD DD 6E FE      [19]  978 	ld	l,-2 (ix)
   45E0 DD 66 FF      [19]  979 	ld	h,-1 (ix)
   45E3 DD 7E F3      [19]  980 	ld	a,-13 (ix)
   ...
   461D DD 34 F3      [23] 1005 	inc	-13 (ix)
   4620 18 BB         [12] 1006 	jr	00129$
   4622                    1007 00126$:
                           1008 ;src/pathfinding.c:212: actual->longitud_camino = 0;
   4622 DD 6E FE      [19] 1009 	ld	l,-2 (ix)
   4625 DD 66 FF      [19] 1010 	ld	h,-1 (ix)
